        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="text-sm text-gray-500">
              <a href="https://puealumni.org" className="text-[#10B981] hover:text-[#0EA5E9]">
                puealumni.org
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://www.presbyuniversity.ac.ke"
                  target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:puaa@puea.ac.ke" className="text-sm hover:text-white transition-colors">
                  puaa@puea.ac.ke
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:0748177184" className="text-sm hover:text-white transition-colors">
                  0748 177 184
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4" />
                <a href="tel:0701010191" className="text-sm hover:text-white transition-colors">
                  0701 010 191
                </a>
              </li>
              <li className="flex items-center gap-2">
